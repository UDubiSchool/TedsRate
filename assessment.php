                ...
                <div ng-if="!userValidated" class="panel hidden col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 user-panel">
                    ...
                    <div ng-if="!showSignin" id="signup">
                        ...
                        <form novalidate name='signupForm' ng-submit="addUser(signupForm) && signupForm.$valid && signupForm.$dirty">
                            ...
                            <div class="form-group">
                                <div role="alert">
                                      <span class="error" ng-show="signupForm.confirm.$error.mismatch && !signupForm.$pristine && signupForm.confirm !== null && signupForm.password !== null">
                                        Passwords do not match.
                                        </span>
                                </div>
                                password is null: {{signupForm.password !== null}}
                                confirm is null: {{signupForm.confirm !== null}}
                                they match: {{signupForm.password == signupForm.confirm}}
