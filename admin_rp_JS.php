    ...
    <?php
     ...
     ?>
		...
		<div id="sitecontainer" style="width:900px;">
            ...
            <link rel="stylesheet"String type="text/css"String href="stylesheets/filter_and_search_stylesheets/datatables.min.css"String/> 
...
<!-- include js files -->
	...
	<script src="javascripts/admin.js"></script>
        <script type="text/javascript" src="javascripts/filter_and_search_plugin_files/datatables.js"></script>   <!-- added by JS -->
        <script type="text/javascript" src="javascripts/testjyotsna.js"></script>   <!-- added by JS -->
