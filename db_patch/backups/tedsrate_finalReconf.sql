...
--
-- Host: localhost
-- Generation Time: Jan 22, 2016 at 10:30 PM
...
INSERT INTO `category` (`categoryID`, `categoryName`, `criterionID`, `languageID`, `categoryDesc`) VALUES
...
(89, 'this comment updated 5th', '2016-01-23 06:29:16', 54);
...
--
ALTER TABLE `category`
  ADD CONSTRAINT `category_ibfk_1` FOREIGN KEY (`languageID`) REFERENCES `language` (`languageID`),
